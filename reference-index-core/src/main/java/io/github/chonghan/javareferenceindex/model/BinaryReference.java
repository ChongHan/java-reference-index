 ...
 * {@code group:name:version} coordinate when available. {@code targetType} is the referenced Java
 * type name, for example {@code org.agrona.collections.IntArrayList}.
 */
